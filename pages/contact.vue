<template>
  <div class="relative isolate bg-white h-dvh">
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <h2 class="text-3xl font-heading font-bold tracking-tight text-gray-900">Contactez-moi</h2>
          <p class="mt-6 text-lg leading-8 text-gray-600">
            Vous avez un projet ? Une question ? N'hésitez pas à me contacter pour en discuter.
          </p>
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            <div class="flex gap-x-4">
              ...
              <dd><a class="hover:text-gray-900" href="mailto:contact@maxidev.fr">contact@maxidev.fr</a></dd>
            </div>
          </dl>
        </div>
      </div>
      <form class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          ...
          <div class="mt-8 flex justify-end">
            <button
              type="submit"
              class="rounded-md bg-primary-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
            >
              Envoyer
            </button>
          </div>
